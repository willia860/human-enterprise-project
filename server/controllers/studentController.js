...
exports.studentLogin = async (req, res, next) => {
  ...
  console.log('fjoijowjojfjowjopfwf');
  ...
  console.log(validPassword, 'validpassword',password, student.password );
  // if (!validPassword) {
  //   errors.password = "Wrong password";
  //   return res.status(404).json(errors);
  // }
  console.log('login studio');
...
exports.updateProfile = async (req, res, next) => {
  try {
    ...
    console.log(req.body.avatar, 'avatarllll')
    if (req.body.avatar !== "") {
